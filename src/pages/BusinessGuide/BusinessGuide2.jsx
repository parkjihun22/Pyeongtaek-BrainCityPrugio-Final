...
const BusinessGuide2 = () => {
    ...
    return (
        <div className={styles.container}>
            <Helmet>
            <title>평택 브레인시티 푸르지오 - 분양일정</title>
            <meta
                name="description"
                content="평택 브레인시티 푸르지오 분양일정을 한눈에 확인하세요. 청약 접수일, 특별공급·1순위 일정, 모델하우스 오픈, 당첨자 발표 및 계약 일정까지 상세히 안내합니다."
            />
            ...
            <h1 className={styles.screenReaderOnly}>평택 브레인시티 푸르지오 - 분양일정</h1>
            <p className={styles.screenReaderOnly}>
            평택 브레인시티 푸르지오의 분양 일정은 청약, 당첨자 발표, 계약 등 
            중요한 날짜들을 안내하는 핵심 정보입니다.
            </p>
