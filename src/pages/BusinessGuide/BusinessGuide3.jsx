...
const BusinessGuide2 = () => {
	...
	return (
		<div className={styles.container}>
			<Helmet>
			{/* 필수 메타 */}
			<title>평택 브레인시티 푸르지오 - 계약서류안내</title>
			<meta
				name="description"
				content="평택 브레인시티 푸르지오 분양 계약을 위한 서류 안내. 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 빠르고 정확하게 확인하세요."
			/>
			<meta name="robots" content="index,follow" />
			<link
				rel="canonical"
				href="https://eliasart.kr/BusinessGuide/documents"
			/>

			{/* Open Graph */}
			<meta property="og:type" content="website" />
			<meta property="og:site_name" content="평택 브레인시티 푸르지오" />
			<meta property="og:title" content="평택 브레인시티 푸르지오 - 계약서류안내" />
			<meta
				property="og:description"
				content="평택 브레인시티 푸르지오 계약서류 안내: 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 확인하세요."
			/>
			<meta property="og:url" content="https://eliasart.kr/BusinessGuide/documents" />
			<meta property="og:image" content="https://eliasart.kr/Main1.png" />
			</Helmet>
			...
			<h1 className={styles.screenReaderOnly}>평택 브레인시티 푸르지오 - 계약서류안내</h1>
			<p className={styles.screenReaderOnly}>
			계약서류안내 페이지에서는 분양 당첨 후 필요한 서류들에 대해 안내합니다. 
			계약 체결을 위해 준비해야 할 서류 목록과 함께, 각 서류의 제출 기한과 
			정확한 준비 방법을 안내하여 고객들이 혼동 없이 준비할 수 있도록 돕습니다.
			</p>
