...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
        ...
        <Helmet>
          <title>평택 브레인시티 푸르지오 - 모집공고 안내</title>
          <meta
            name="description"
            content="평택 브레인시티 푸르지오 모집공고를 한눈에 확인하세요. 공급세대수·공급면적·분양가, 청약일정·자격, 당첨자 발표·계약 및 유의사항을 안내합니다."
          />
        ...
        <h1 className={styles.screenReaderOnly}>
          평택 브레인시티 푸르지오 - 모집공고안내
        </h1>
        <p className={styles.screenReaderOnly}>
          평택 브레인시티 푸르지오 모집공고는 분양 전 단계에서 중요한 안내문입니다. 
          이 페이지에서는 모집공고에 포함된 주요 일정, 자격 조건, 준비 서류 등을 명확하게 안내하여 
          예비 청약자들이 혼동 없이 청약을 준비할 수 있도록 지원합니다. 
          모집공고를 통해 필수 정보들을 빠짐없이 확인하세요.
        </p>

        <div className={styles.textBox}>
          <div>입주자 모집공고안내를 확인하세요</div>
          <div>평택 브레인시티 푸르지오</div>
        </div>

      {/* <img
        className={`${styles.image2} ${isImage2Loaded ? styles.showImage2 : ''}`}
        src={page1}
        alt="평택 브레인시티 푸르지오모집공고안내-image1"
