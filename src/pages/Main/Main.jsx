...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `브레인시티 대단지 프리미엄`,
    text2: `평택 브레인시티 푸르지오 총 1,990세대<br/>
            브레인시티 주거타운의 중심`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망 호재`,
    text2: `지제역(KTX·SRT)·평택지제역(1호선) 연계<br/>
            경부·서해안·평택제천고속도로 사통팔달`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `의료·생활 인프라 풍부`,
    text2: `브레인시티 의료복합타운(예정)·종합병원 접근성<br/>
            코스트코·대형마트 등 원스톱 생활`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `쾌적한 자연·친환경 환경`,
    text2: `삼정근린공원 등 풍부한 녹지<br/>
            브레인시티 내 공원·녹지축 조성으로 쾌적한 생활`,
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub}>
              ...
              <div className={styles.mainImageTitleBox}>
                <div className={styles.mainImageText}>브레인시티가 기다린 미래 프리미엄</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - KTX·SRT 지제역 인접, 경부·서해안·평택제천고속도로 등 사통팔달 교통망<br />
                  - 평택 아주대학교병원(예정)·의료복합타운과 연계되는 안심 의료 인프라<br />
                  - 삼정근린공원·서정리천 수변공간 등 쾌적한 자연과 휴식 인프라<br />
                  - 코스트코·롯데마트·이마트·AK플라자 등 풍부한 생활·문화 인프라
                </div>
              ...
              <div className={styles.menuBox}>
                <img
                  src={section1_Image1}
                  alt="평택 브레인시티 푸르지오 브랜드소개-image2"
                  loading="lazy"
                  decoding="async"
                />
          ...
          <div className={styles.section}>
            <div className={styles.section8}>
              ...
              <img
                src={section8Img3}
                alt="평택 브레인시티 푸르지오 입지환경소개-image2"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="평택 브레인시티 푸르지오 아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="평택 브레인시티 푸르지오 브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>평택 브레인시티 푸르지오</div>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="평택 브레인시티 푸르지오 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="평택 브레인시티 푸르지오 mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              브레인시티의 새로운 시작 <br/>높은 미래가치
              <br/>브랜드 평판 1위 푸르지오
              <br />
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text2}>
              ...
              <div className={styles.text3}>
                - KTX·SRT 지제역 인접, 경부·서해안·평택제천고속도로 등 사통팔달 교통망<br />
                - 평택 아주대학교병원(예정) 및 의료복합타운 연계로 안심 의료 인프라<br />
                - 삼정근린공원·서정리천 등 녹지와 공원 인접, 쾌적한 자연환경<br />
                - 코스트코·롯데마트·이마트·AK플라자 등 풍부한 생활·문화 인프라 밀집
              </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="평택 브레인시티 푸르지오 모바일 입지안내 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 평택 브레인시티 푸르지오에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="평택 브레인시티 푸르지오 모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="평택 브레인시티 푸르지오 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="평택 브레인시티 푸르지오 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
