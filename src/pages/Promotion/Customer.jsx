...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/xnnjvebv", {
        method: "POST",
  ...
  return (
    ...
    <>
        <Helmet>
          ...
          <title>평택 브레인시티 푸르지오 - 관심고객등록</title>
          <meta
            name="description"
            content="평택 브레인시티 푸르지오 관심고객 등록 시 모델하우스 방문예약, 위치 및 현장정보를 사전에 안내받으실 수 있습니다."
          />
          <meta name="robots" content="index,follow" />
          <link rel="canonical" href="https://eliasart.kr/Promotion/Customer" />

          {/* Open Graph */}
          <meta property="og:type" content="website" />
          <meta property="og:site_name" content="평택 브레인시티 푸르지오" />
          <meta property="og:title" content="평택 브레인시티 푸르지오 - 관심고객등록" />
          <meta
            property="og:description"
            content="평택 브레인시티 푸르지오 관심고객 등록 시 모델하우스 방문예약, 위치 및 현장정보를 사전에 안내받으실 수 있습니다."
          />
          <meta property="og:url" content="https://eliasart.kr/Promotion/Customer" />
          <meta property="og:image" content="https://eliasart.kr/img/og/customer.jpg" />
          <meta property="og:image:width" content="1200" />
          <meta property="og:image:height" content="630" />

          {/* Twitter */}
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content="평택 브레인시티 푸르지오 - 관심고객등록" />
          <meta
            name="twitter:description"
            content="평택 브레인시티 푸르지오 관심고객 등록 시 모델하우스 방문예약, 위치 및 현장정보를 사전에 안내받으실 수 있습니다."
          />
          <meta name="twitter:image" content="https://eliasart.kr/img/og/customer.jpg" />
          <meta name="twitter:url" content="https://eliasart.kr/Promotion/Customer" />
          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "@type": "WebPage",
              "name": "평택 브레인시티 푸르지오 - 관심고객등록",
              "url": "https://eliasart.kr/Promotion/Customer",
              "description":
                "평택 브레인시티 푸르지오 관심고객 등록 시 모델하우스 방문예약, 위치 및 현장정보를 사전에 안내받으실 수 있습니다.",
              "primaryImageOfPage": {
                "@type": "ImageObject",
                "contentUrl": "https://eliasart.kr/img/og/customer.jpg",
                "width": 1200,
                "height": 630
              },
              "breadcrumb": {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 2, "name": "관심고객등록", "item": "https://eliasart.kr/Promotion/Customer" }
                ]
              }
            })}
          </script>
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>평택 브레인시티 푸르지오</h2>
